...
MIN_ENTRY_TIME_TO_EXPIRY_SECONDS = 75
MAX_ENTRY_TIME_TO_EXPIRY_SECONDS = 180
...
SELL_OVERPRICED_EDGE = 0.05
SELL_OVERPRICED_MIN_PNL_USD = 0.0
MODEL_MARKET_BLEND = 0.35
MODEL_PROBABILITY_CLIP_MIN = 0.05
MODEL_PROBABILITY_CLIP_MAX = 0.95
...
ONLINE_CALIBRATION_MIN_SAMPLES = 200
ONLINE_CALIBRATION_MIN_ROUNDS = 20
ONLINE_CALIBRATION_WINDOW_SAMPLES = 2000
ONLINE_CALIBRATION_SAMPLE_SECONDS = 30
